...
// - 웹 브라우저와 저장 공간에 데이터 저장(브라우저를 닫아도 데이터가 유지)

localStorage.setItem('key', 'value');
localStorage.setItem('username', '진우태');

// cf) 로컬 스토리지와 데이터는 문자열만 저장 가능
// : 기본 자료형 또한 저장 가능 >> 문자열로 인식
localStorage.setItem('userAge', 27);
