...
// cf) 경로 VS 도메인
// 1) 도메인
//   :웹 사이트의 주소 "naver.com", "google.com" 등의 서버위치 (IP 주소)를 식별하는 역할
// 2) 경로
//   : 도메인 뒤에 이어지는 부분, 서버(사이트) 내의 특정 파일이나 페이지 위치를 나타냄
...
let date = new Date(); // 현재날짜, 시간을 반환
// cf) Date 객체에 .getTime() 속성: 시간 데이터 가져오기
//     Date 객체에 .setTime() 속성: 시간 데이터 설정오기
...
document.cookie = "username=qwer123;" + expires + "; path=/;"