...
callback1(print2) // print2(콜백함수) 함수를 callback1(메인 올직의)의 인자로 전달

// 3) 화살표함수를 사용한 콜백함수
console.log('=== 콜백(화살표함수) ===');
function callback2(number, callbackFunc, otherFunc) {
  // number 값이 짝수면 callbackFunc
  // , 홀수면 otherFunc
...
const even = even => console.log(`${even} 값은 짝수이빈다.`);
const oddNumber = oddNum => console.log(`${oddNum} 값은 홀수 입니다.`);
