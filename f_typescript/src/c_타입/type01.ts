...
// ? 타입 종류
// 1. 기본 타입(원시타입 - string, number, boolean 등)
...
console.log(stringReturn('진', '우태'));

// & 4. null & undefined
// null: 아무것도 없음, 데이터가 잘못된 경우
// undefinde: 변수 생성은 했지만, 안에 값이 없을 경우
...
let unkowonData; // let unkowonData: any
// : 직접적인 타입 명시를 하지 않을 경우 값이 할당되기 전까지 자동으로 any 타입으로 인식
